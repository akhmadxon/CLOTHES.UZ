...
const ProductFormModal = ({ open, handleClose, item }) => {
  ...
  const fetchCategoryData = async () => {
    try {
      const response = await category.get(paginationParams);
            ...
            {({
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <Box sx={{ mt: 2, textAlign: "right" }}>
                  <Button onClick={handleClose} sx={{ mr: 2,  marginBottom:"8px" , color:"black"}}>
                    Cancel
                  </Button>
                  <Button
