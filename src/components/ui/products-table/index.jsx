              ...
              <StyledTableRow key={item.product_id}>
                ...
                <StyledTableCell align="center">
                  <div className='flex justify-center'>
                    <IconButton aria-label="delete" sx={{ color: "red" }} onClick={() => deleteItem(item.product_id)}>
                      <DeleteIcon />
                    </IconButton>
                    <IconButton aria-label="addPhoto"  sx={{ color: "black" }}onClick={() => uploadFile(item.product_id)}>
                      <AddPhotoAlternateIcon />
                    </IconButton>
                    <button onClick={()=>{navigate(`/products/${product_id}`)}}   className=' text-gray-500'><VisibilityIcon/></button>
                  </div>
                </StyledTableCell>
              </StyledTableRow>
            ))}
