              ...
              <StyledTableRow key={item.id}>
                ...
                <StyledTableCell align="center">
                  <div className='flex gap-2 justify-center'>
                    <IconButton aria-label="edit" onClick={() => handleEditWorker(item)} sx={{ color: "black" }} >
                      <EditIcon />
                    </IconButton>
                    <IconButton aria-label="delete" onClick={() => handleDeleteWorker(item.id)} sx={{ color: "red" }} >
                      <DeleteIcon />
                    </IconButton>
                  </div>
                </StyledTableCell>
